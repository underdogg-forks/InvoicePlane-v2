 ...
 * fixture (console errors + uncaught page exceptions) across the whole
 * run and prints/writes a single consolidated report at the end — the
 * point being to surface errors that happened silently in tests that
 * never explicitly checked for them, not just the ones that already fail
 * loudly on their own.
 */
