...
namespace Modules\Invoices\Tests\Unit\Peppol\Providers\LetsPeppol;

use Illuminate\Support\Facades\Http;
use Modules\Core\Tests\AbstractTestCase;
use Modules\Invoices\Peppol\Providers\LetsPeppol\LetsPeppolProvider;
use PHPUnit\Framework\Attributes\Group;
use PHPUnit\Framework\Attributes\Test;
use ReflectionProperty;

/**
 * LetsPeppolProviderTest - proves OAuth2 authentication is actually attempted on the real
 ...
 */
#[Group('peppol')]
class LetsPeppolProviderTest extends AbstractTestCase
{
    #[Test]
    public function it_fails_test_connection_without_credentials(): void
    {
        /* Arrange */
        $provider = new LetsPeppolProvider();
    ...
    public function it_succeeds_test_connection_when_the_oauth2_token_exchange_succeeds(): void
    {
        /* Arrange */
        Http::fake([
            'https://auth.letspeppol.com/oauth/token' => Http::response([
        ...
        Http::assertSent(fn ($request) => $request->url() === 'https://auth.letspeppol.com/oauth/token'
    ...
    public function it_refuses_to_send_an_invoice_when_authentication_fails_and_never_reaches_the_send_endpoint(): void
    {
        ...
        /* Act */
        $result = $provider->sendInvoice(['xml' => '<Invoice/>', 'recipient_id' => '123', 'recipient_scheme' => '0088']);
    ...
    private function providerWithConfig(array $config): LetsPeppolProvider
    {
        $provider = new LetsPeppolProvider();
